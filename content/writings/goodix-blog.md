...
of course, just prompting "make no mistake" wouldn't work. or will it?
...
after ticket 13, we were able to retrieve the full 10564 byte of data. and the first `verify-match` was achieved by ticket 18 by
a python script.
...
solving these bugs was the agents' work. but testing every little change was a real pain in the ass. anyways, I went through. and by ticket 42, I had a deployed and working driver. it would instantly unlock my device. everything was rainbows and sunshine.

### the brutal truth

while demoing my hardwork to my friends I realised something which I was ignoring previously -- the FAR.
...
that's bad. a stranger has a 70% chance to unlock where my own fingerprints barely gets recognised.

the fix: 11 to 14 (0.11% FAR), and reduce enrollment stages from 12 to 5.

this is not a fix. it's a punishment! it would always give `no-match` this way. tickets after tickets
refinements after refinements I thought I would make it work after some iterations but ended up
...
**It Works!** and that's very important because I've been longing to use my fingerprint unlock since the last 3 years.
